...
if __name__ == "__main__":
    ...
    config["kitti_dataset_root"] = "/root/autodl-fs/HAO_MOS"
    ...
    scan = os.path.join(config["kitti_dataset_root"], 'non_ground_velodyne', "000043.bin")
    # scan = os.path.join(config["kitti_dataset_root"], 'sequences', "006", 'non_ground_velodyne', "000017.bin")
    pcd = o3d.geometry.PointCloud()
