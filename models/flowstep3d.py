...
from utils.model_utils.flowstep3d_util import *
...
class FlowStep3D(nn.Module):
    def __init__(self, args, use_instance_norm=False, loc_flow_nn=16, loc_flow_rad=1.5, k_decay_fact=1.0):
    ...
    def forward(self, pc1, pc2, feature1, feature2, iters=4):
        # ---------------------- init ----------------------------
        flow_predictions = []
