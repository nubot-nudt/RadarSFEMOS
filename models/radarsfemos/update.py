...
class ClassificationHead(nn.Module):
    def __init__(self, input_dim=128, hidden_dim=256):
        ...
        self.conv1 = nn.Conv1d(input_dim, hidden_dim, 3, padding=1).cuda()
        self.conv2 = nn.Conv1d(hidden_dim, 1, 3, padding=1).cuda()
